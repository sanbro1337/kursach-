...
namespace ToDoList
{
    public class MainProgramm
    {
        public static void InMainProgramm()
        {
            ...
            string[] text1 = { "Добавить себе задачу", "Добавить общую задачу", "Добавить аадачу другому пользователю", "Посмотреть свои задачи", "Посмотреть задачи других пользователей", "Посмотреть общие задачи"};
